...
import data from '../shopProductData/data.js'
...
function BannerShop() {
  ...
  useEffect(function(){
    setListProduct(()=>{
        const newData = []
        data.product.map(colection=>{
            colection.product.map(item=>{
                newData.push(item)
            })
        })
  ...
  return (
    ...
    <div className={style.BannerShop}>
        <div className={style.header}>
            <img src='https://salt.tikicdn.com/cache/w220/ts/seller/ee/fa/a0/98f3f134f85cff2c6972c31777629aa0.png'  className={style.avatar}/>
