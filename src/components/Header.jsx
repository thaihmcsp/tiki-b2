      ...
      <div className="Header">
                ...
                <div className="HeaderTopContainerInput">
                  <div className="InputCover">
                    ...
                    <div className="ShowCoverInput">
                      ...
                      <div className="HistorySeach" style={search ? { display: "inline-block" } : { display: "none" }}>
                ...
                {user_information.username ? (
                  <div className="HeaderTopContainerUser cursorPoiter">
                    ...
                    <div className="header_navbar_iteam_mypage_selec">
                      <div className="header_navbar_iteam_mypage_selec-item">Đơn hàng của tôi</div>
                      <div className="header_navbar_iteam_mypage_selec-item">Thông báo của tôi</div>
        ...
        <div className="HeaderMobie">
          ...
          <div className="HeaderMobieMidle">
            <input type="text" name="" id="" placeholder="Bạn tìm gì hôm nay ?" className="HeaderMobieText" onChange={(e) => SearchTitle(e.target.value)} />
          </div>
