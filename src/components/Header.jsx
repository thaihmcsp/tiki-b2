...
function Header(props) {
  ...
  function SearchTitle(input) {
    if (input.trim() != "") {
      document
        .querySelector(".CoverInputListItems")
        .setAttribute("style", "display: none;");
      document
        .querySelector(".HistorySeach")
  ...
  function logout() {
    ...
    document.cookie =
      "tiki-user" + "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;";
                ...
                <div className="HeaderTopContainerInput">
                  <div className="InputCover">
                    <input
                      ...
                      name=""
                      id=""
                      className="componentHeaderInput"
                    ...
                    <div className="ShowCoverInput">
                        ...
                        {word.slice(0, 8).map((value) => {
                          return (
                            <div
                              ...
                              onClick={() => SeachInputData(value.categoryName)}
                            >
                      ...
                      <div className="CoverInputListItems">
                        <a href="" className="HeaderCoverInput">
                          <span className="HeaderCoverInputText">
                            Săn Sale Công Nghệ
                          </span>
                          <img
                            src="https://salt.tikicdn.com/cache/140x28/ts/banner/ec/32/4e/2227fe4869feaf2a75598c0ab0a8cf29.png"
                            alt=""
                          />
                        </a>
                        ...
                        <div className="ShowCoverInputListItem">
                          ...
                          <a href="" className="InputCoverLists">
                            <img
                              src="https://salt.tikicdn.com/cache/280x280/ts/product/41/78/c4/a4425d3a9679273ea7675c59a3264aba.png"
                              alt=""
                              witdth="50px"
                              height="50px"
                            />
                          ...
                          <a href="" className="InputCoverLists">
                            <img
                              src="https://salt.tikicdn.com/cache/280x280/ts/product/5c/57/85/312c7a38df0312e7525a18f61c5a0fbc.jpg"
                              alt=""
                              witdth="50px"
                              height="50px"
                            />
                          ...
                          <a href="" className="InputCoverLists">
                            <img
                              src="https://salt.tikicdn.com/cache/280x280/ts/product/63/20/7a/86a64e68a0b46f31485428f5665ebded.jpg"
                              alt=""
                              witdth="50px"
                              height="50px"
                            />
                          ...
                          <a href="" className="InputCoverLists">
                            <img
                              src="https://salt.tikicdn.com/cache/280x280/ts/product/50/db/4d/fe17aa78bc1ab2adb45b06140c945033.jpg"
                              alt=""
                              witdth="50px"
                              height="50px"
                            />
                          ...
                          <a href="" className="InputCoverLists">
                            <img
                              src="https://salt.tikicdn.com/cache/280x280/ts/product/55/25/7f/1d055982a3231bfaec4a059c5b5b3a66.jpg"
                              alt=""
                              witdth="50px"
                              height="50px"
                            />
                          ...
                          <a href="" className="InputCoverLists">
                            <img
                              src="https://salt.tikicdn.com/cache/280x280/ts/product/29/ee/bb/c2dfe5c42f265250352b434c4dd73b1e.jpg"
                              alt=""
                              witdth="50px"
                              height="50px"
                            />
                        ...
                        <div className="CatogoryAttenion">
                          <a href="" className="CatogoryList">
                            <div className="CatogoryListTitle">
                              <img
                                src="https://salt.tikicdn.com/ts/category/15/23/95/e2da53c1fadff812db3f6ecb7c950675.png"
                                alt=""
                                witdth="64.5px"
                                height="64.5px"
                              />
                          ...
                          <a href="" className="CatogoryList">
                            <div className="CatogoryListTitle">
                              <img
                                src="https://salt.tikicdn.com/ts/category/fb/83/30/b1a511c06ebc74d1b9e198073bb5762b.png"
                                alt=""
                                witdth="64.5px"
                                height="64.5px"
                              />
                          ...
                          <a href="" className="CatogoryList">
                            <div className="CatogoryListTitle">
                              <img
                                src="https://salt.tikicdn.com/cache/280x280/ts/product/35/6c/4b/709aef22ee52628dcdbdc857ba1bc46c.jpg"
                                alt=""
                                witdth="64.5px"
                                height="64.5px"
                              />
                          ...
                          <a href="" className="CatogoryList">
                            <div className="CatogoryListTitle">
                              <img
                                src="https://salt.tikicdn.com/cache/280x280/ts/product/6b/bb/91/9114806fba6f0ecf0d0a247ae28317ba.jpg"
                                alt=""
                                witdth="64.5px"
                                height="64.5px"
                              />
                          ...
                          <a href="" className="CatogoryList">
                            <div className="CatogoryListTitle">
                              <img
                                src="https://salt.tikicdn.com/ts/category/cf/ed/e1/96216aae6dd0e2beeb5e91d301649d28.png"
                                alt=""
                                witdth="64.5px"
                                height="64.5px"
                              />
                          ...
                          <a href="" className="CatogoryList">
                            <div className="CatogoryListTitle">
                              <img
                                src="https://salt.tikicdn.com/cache/280x280/ts/product/51/c1/28/80704f786a6064376698c010f7a5891c.jpg"
                                alt=""
                                witdth="64.5px"
                                height="64.5px"
                              />
                  ...
                  <button
                    className="HeaderbuttonSeach cursorPoiter"
                    onClick={SeachInputDataProduct}
                  >
                    <img
                    ...
                    <img
                      src={
                        user_information.avatar.length > 0
                          ...
                          : "https://salt.tikicdn.com/ts/upload/67/de/1e/90e54b0a7a59948dd910ba50954c702e.png"
                      }
                      alt=""
                      ...
                      <span>
                        <div>
                          ...
                          <img
                            ...
                            alt=""
                            className="HeaderUserImgdown"
                          />
                        </div>
                      </span>
                    </div>
                    <div className="header_navbar_iteam_mypage_selec">
                      <div className="header_navbar_iteam_mypage_selec-item">
                        Đơn hàng của tôi
                      </div>
                      <div className="header_navbar_iteam_mypage_selec-item">
                        Thông báo của tôi
